...
from qbraid_core.exceptions import HttpStatusMixin, QbraidException
...
class EnvironmentServiceRequestError(HttpStatusMixin, QbraidEnvironmentError):
    """
...
class EnvironmentDownloadError(HttpStatusMixin, EnvironmentOperationError):
