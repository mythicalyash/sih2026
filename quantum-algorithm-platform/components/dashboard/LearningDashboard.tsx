...
const DEFAULT_METRICS: DashboardMetrics = {
  ...
  kpis: [
    {
      ...
      value: '8/17',
      subtitle: '47% Completed',
      footer: '8 of 17 core modules completed',
      tone: 'orange',
      icon: 'book-open',
    },
    {
  ...
  radar_data: [
    { concept: 'Phase Kickback', score: 42, category: 'Gates & Oracles' },
    { concept: 'Quantum Superposition', score: 94, category: 'Foundations' },
    { concept: 'Entanglement & Bell States', score: 88, category: 'Foundations' },
    { concept: 'Quantum Gates & Circuits', score: 85, category: 'Circuits' },
    { concept: 'Quantum Algorithms', score: 70, category: 'Algorithms' },
    { concept: 'Measurement & Protocols', score: 65, category: 'Protocols' },
  ],
  focus_area: {
