  ...
  return (
    <header className="topbar">
      ...
      <div className="top-actions">
        ...
        <button className="avatar small" onClick={() => setActive('Settings')}>
          AM
        </button>
      </div>
    </header>
  ...
  return (
    <div className="page-content">
      <div className="welcome-row">
        <div>
          <div className="eyebrow">Thursday, August 29, 2024</div>
          <h1>
            Good morning, Arjun<span className="accent-dot">.</span>
          </h1>
          <p className="subhead">Your quantum journey is picking up momentum.</p>
        </div>
      ...
      <div className="hero-grid">
        <Card className="lecture-card">
          ...
          <div className="lecture-body">
            ...
            <div className="lecture-info">
              ...
              <p>Understand how a qubit can be in multiple states at once.</p>
              <div className="progress-row">
                <span>4 of 6 lessons</span>
                <strong>68%</strong>
              </div>
              <ProgressBar value={68} />
              <button className="text-button" onClick={() => setActive('Learn Quantum')}>
                Continue lecture <ChevronRight />
              </button>
            </div>
          </div>
        </Card>
        ...
        <Card className="simulation-card">
          <div className="card-head">
            <div>
              <div className="eyebrow">LAST SIMULATION</div>
              <h2>Bell state experiment</h2>
            </div>
          ...
          <div className="sim-footer">
            <div>
              <span className="live-dot" /> Aer simulator <small>· 0.004s</small>
            </div>
      ...
      <Card className="recommend-card">
        ...
        <div className="recommend-copy">
          <div className="eyebrow accent-text">RECOMMENDED BY YOUR AI TUTOR</div>
          <h2>Strengthen your intuition for superposition</h2>
          <p>
            You&apos;re getting the right answers, but your confidence dipped on the last quiz. Try this focused 5-minute drill.
          </p>
        </div>
        <button className="button secondary" onClick={() => setActive('AI Tutor')}>
        ...
        <Card className="streak-card">
          <div className="card-head">
            <div>
              ...
              <h2>
                12 days <span className="flame-word"><Flame /> on fire</span>
              </h2>
            </div>
          ...
          <div className="activity-list">
            {activity.map(([type, title, date, xp, tone]) => (
              <div className="activity-item" key={title}>
                <div className={`activity-icon ${tone}`}><Activity /></div>
                <div>
                  <strong>{title}</strong>
                  <span>{type} · {date}</span>
                </div>
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.suggestions && data.suggestions.length > 0) {
          reply +=
            '<br/><br/><strong>Suggestions:</strong><ul class="list-disc pl-4 mt-1">' +
    ...
    <div className="page-content tutor-page">
      <div className="tutor-header">
        <div>
          ...
          <h1>
            Let&apos;s figure it out<span className="accent-dot">.</span>
          </h1>
          <p className="subhead">Deterministic analysis &amp; quantum physics explanations.</p>
        </div>
        <div className="context-chip">
          <BrainCircuit /> Anchored to <strong>Superposition &amp; Entanglement</strong>
          <X />
        </div>
      </div>
      <Card className="chat-card">
        <div className="chat-messages">
          ...
          {loading && (
            <div className="message tutor">
              ...
              <div className="message-copy text-gray-400 font-mono text-xs">
                Analyzing circuit statevector...
              </div>
            </div>
          )}
        </div>
        <div className="prompt-chips">
          ...
          <button onClick={() => sendMessage('What is the Bell state (|00> + |11>)/sqrt(2)?')}>
    ...
    <div className="page-content">
      <div className="welcome-row">
        <div>
          ...
          <h1>
            Progress, measured<span className="accent-dot">.</span>
          </h1>
          <p className="subhead">Small experiments compound into fluency.</p>
        </div>
      ...
      <div className="metrics">
        ...
        <Card>
          ...
          <small>Top 12% of learners</small>
        </Card>
      </div>
      <div className="dashboard-grid">
        ...
        <Card className="weak-card">
          <div className="eyebrow">TOPICS TO REVISIT</div>
          <h2>Personalized focus</h2>
          {[
            ['Phase estimation', 42],
            ['Quantum Fourier transform', 58],
            ['Measurement', 71],
            ['Qubits', 89],
          ].map(([label, val]) => (
    ...
    <div className="page-content settings-page">
      ...
      <div className="settings-layout">
        ...
        <Card className="settings-form">
          ...
          <label>
            Bio
            <textarea defaultValue="Learning quantum algorithms one circuit at a time." />
          </label>
